...
// Paths
const entryHTML = config.getPathIndexHtml();
  ...
  return {
    ...
    module: {
      ...
      rules: [
        ...
        {
          test: /\.(png|jpg|gif|jpeg|glb|gltf|mp4|mp3)$/i,
          use: [
            {
              loader: 'url-loader',
            },
    ...
    devServer: {
      ...
      open: false,
      // what to check in the local network not through localhost but through the IP of this computer
      // host: '0.0.0.0'
    },
    ...
    plugins: plugins.concat(
      new HtmlWebpackPlugin({
        ...
        template: path.join(__dirname, entryHTML),
        filename: '../index.html',
        env: env.NODE_ENV,
